...
public class registro_materiales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // SPINNER
        String[] opcionesMateriales = {"Seleccionar material", "Papel", "Plástico", "Vidrio", "Metal"};
        // FECHA
        ...
        materialSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                if (position == 0) {
                    Toast.makeText(registro_materiales.this, "Por favor, selecciona material", Toast.LENGTH_SHORT).show();
                } else {
